      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _utils.Log.info('\nRemoved the custom domain name from app ' + _utils.Log.magenta(result.data.domainUnset.name) + '\n');

            _context.next = 12;
            return (0, _list2.default)();

          case 12:
            return _context.abrupt('return', result.data.domainUnset);
