...
function doLogin(user, pass) {
  ...
  gql.login({ username: user, password: pass }).then(function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(res) {
      var _res$data$loginWithPa, _res$data$loginWithPa2, _id, email, token, tokenExpires, keys, homeDir, hasKey, keyPair;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              keys.forEach(function (k) {
                if ((0, _utils.exists)(homeDir + '/.reaction/keys/' + k.title)) {
                  hasKey = true;
                }
              });
