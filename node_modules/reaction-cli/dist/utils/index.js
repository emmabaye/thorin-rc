...
exports.provisionAssets = exports.getVersions = exports.track = exports.loadStyles = exports.loadPlugins = exports.Log = exports.initialize = exports.Config = exports.checkMeteor = exports.checkDeps = exports.checkIfInReactionDir = undefined;
...
Object.keys(_ssh).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
var _assetProvisioner = require('./asset-provisioner');

Object.defineProperty(exports, 'provisionAssets', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_assetProvisioner).default;
  }
});
